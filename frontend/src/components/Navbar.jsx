  ...
  return (
    <div className="bg-[#1B2537] h-22.5 flex justify-between items-center w-full px-15 ">
      ...
      <form
        ...
        className="bg-[#141A28] w-87.5 h-10 p-3 rounded-lg flex justify-between items-center "
      >
        {/* <p className='text-gray-500'>Search</p> */}
        <input
          className="text-white w-4/5 outline-none"
          placeholder="Search"
          onChange={(e) => {
        ...
        <button type="submit">
          {" "}
          <FontAwesomeIcon
            className="text-lg text-gray-500 active:scale-110"
