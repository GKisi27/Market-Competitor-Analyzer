...
const ChartSection = () => {
  ...
  return (
    <div className="flex justify-between items-center gap-10 p-15 mt-6">
      <div className="w-3/4 h-96 ">
        <PriceChart />
      </div>
      <div className="w-1/4 bg-[var(--bg-input)] h-96 px-8 flex flex-col justify-center gap-8 rounded-lg">
