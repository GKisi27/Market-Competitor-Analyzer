  ...
  return (
    <div className="px-15 flex justify-between gap-5 mt-4">
      ...
      <div className="w-3/4 h-[480px]">
        <GapChart onDataLoaded={setCompetitorCourses} showLegend={false} height="h-full" />
      </div>
      ...
      <div className="bg-[var(--bg-input)] w-1/4 flex flex-col gap-3 justify-center px-4 py-5 rounded-lg">
        ...
        >
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="font-semibold text-sm">Courses Offered</span>
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-sm">Students Enrolled</span>
          </div>
          <p className="text-xs opacity-60 mt-1 pl-5">Relative score (0–100)</p>
        </div>
      </div>
    </div>
  );
